                                ...
                                <tbody>
                                    ...
                                    <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs p-4">
                                        <span class="flex space-x-2">
                                            <div class="item">
                                                <jet-button type="button" @click="processApp(item.id, item.jenis_usulan, 'Sesuai')">
                                                    Sesuai
                                                </jet-button>
                                            </div>
                                            <div class="item">
                                                <jet-danger-button type="button" @click="processApp(item.id, item.jenis_usulan, 'Tidak Sesuai')">
                                                    Tidak Sesuai
                                                </jet-danger-button>
                                            </div>
                                        </span>
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            processApp(id, jenis_usulan, status){
                let txtConfirm = status == 'Sesuai' ? 'Memproses' : 'Menolak';
                if (confirm(`Apakah Anda Yakin Untuk ${txtConfirm} Usulan Ini?`)) {
                    axios.post(this.route('PBJ.permohonan.approval'), {
                        id: id,
