        ...
        <main class="flex w-full h-screen">
            ...
            <section class="w-full p-4">
                <div class="w-full h-64 p-4 text-md">
                    ...
                    <h1 class="font-bold text-lg text-center border-b-2 border-red-500">Data Permohonan {{ title }} Pengadaaan Barang & Jasa Dari Pengusul</h1>
    ...
    export default defineComponent({
        ...
        data() {
            return {
                ...
                listCols: ['No', 'Nama Pengusul', 'Nomor Identitas', 'Status Pengusul', 'No HP', 'Email', 'Keterangan', 'Status', 'Opsi', 'Aksi'],
            }
        },
        methods: {
            ...
            search() {
                this.$inertia.replace(this.route('Validator.permohonan', {term: this.term, perPage: this.page, jenisUsulan: this.jenisUsulan}))
            },
            processApp(id, jenis_usulan, status){
                ...
                if (confirm(`Apakah Anda Yakin Untuk ${txtConfirm} Usulan Ini?`)) {
                    axios.post(this.route('Validator.permohonan.approval'), {
                        id: id,
