<template>
    <div class="bg-gray-100 font-sans w-full m-0 z-50">
        <div class="bg-sky-900 shadow">
            <div class="container mx-auto px-4">
                <div class="flex items-center justify-between py-4">
                    ...
                    <div class="hidden sm:flex sm:items-center">
                        <Link href="/" class="text-gray-100 text-sm font-semibold hover:text-purple-600 mr-4">Home</Link>
                        <Link href="/prosedur" class="text-gray-100 text-sm font-semibold hover:text-purple-600 mr-4">Prosedur</Link>
                        <Link href="/ketentuan" class="text-gray-100 text-sm font-semibold hover:text-purple-600 mr-4">Ketentuan</Link>
                        <Link href="/listInvent" class="text-gray-100 text-sm font-semibold hover:text-purple-600 mr-4">Daftar Barang</Link>
                        <Link href="/login" class="text-gray-100 text-sm font-semibold hover:text-purple-600 mr-4">Login</Link>
                    </div>
                ...
                <div class="block sm:hidden bg-sky-900 border-t-2 py-2">
                    <div class="flex flex-col">
                    <Link href="/" class="text-gray-100 text-sm font-semibold hover:text-purple-600 mb-1">Home</Link>
                    <Link href="/prosedur" class="text-gray-100 text-sm font-semibold hover:text-purple-600 mb-1">Prosedur</Link>
                    <Link href="/ketentuan" class="text-gray-100 text-sm font-semibold hover:text-purple-600 mb-1">Ketentuan</Link>
                    <Link href="/listInvent" class="text-gray-100 text-sm font-semibold hover:text-purple-600 mb-1">Daftar Barang</Link>
                    <Link href="/login" class="text-gray-100 text-sm font-semibold hover:text-purple-600 mr-1">Login</Link>
                    </div>
                </div>
            </div>
